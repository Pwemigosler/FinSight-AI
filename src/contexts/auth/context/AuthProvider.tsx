...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const { addBankCard, removeBankCard, setDefaultCard } = useCardManagement(bankCardService, setLinkedCards);
...
function useAuthMethods(userService: UserService) {
...
function useCardManagement(bankCardService: BankCardService, setLinkedCards: React.Dispatch<React.SetStateAction<BankCard[]>>) {
